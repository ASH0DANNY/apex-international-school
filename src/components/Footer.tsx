...
const Footer = () => {
  const FooterLinkItems = [
    ...
    { name: "Admission2", link: "/admission2" },
    { name: "Admission3", link: "/admission3" },
  ];
  const FooterFollowItems = [
    ...
    { index: 2, icon: XIcon, link: "https://twitter.com/asadsad" },
    { index: 3, icon: GoogleIcon, link: "https://plus.google.com/a" },
    {
      index: 4,
      icon: YouTubeIcon,
      link: "https://www.youtube.com/ahttps://youtube.com/@apexgrd?si=KAxSYwJccm1QSiFZ",
    },
    { index: 5, icon: LinkedInIcon, link: "https://www.linkedin.com/a" },
    { index: 6, icon: InstagramIcon, link: "https://www.instagram.com/a" },
  ];
  return (
    <>
      <div className="w-full bg-primary-dark text-white p-4 grid grid-flow-row">
        {/* Upper Row */}
        <div className="grid grid-flow-row md:grid-flow-col gap-2 px-5 md:px-40 py-5 md:py-10 border-b-2 border-white">
          <div>
        ...
        <div className="grid grid-flow-row md:grid-flow-col gap-4 md:gap-2 py-5">
          <div className="p-1 flex flex-row gap-3 md:justify-center items-center">
            ...
            <div className="flex flex-col ">
              <p className="text-sm text-gray-500 font-semibold ">Contact Us</p>
      ...
      <div className="w-full p-1 md:p-2 bg-primary flex justify-center items-center">
        <p className="text-xs md:text-sm text-yellow-400">Developed by : Loric Software</p>
      </div>
    </>
  );
};
